...
namespace TerrainEngine
{
    ...
    public class TerrainSample : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            terrain.Load("Terrain1", 256, 256, 12.0f, 3.0f);
        ...
        private void UpdateInput()
        {
            ...
            // Change camera
            if (gamePad.Buttons.LeftShoulder == ButtonState.Pressed || keyboard.IsKeyDown(Keys.D1))
                cameraManager.SetActiveCamera(0);
            else if (gamePad.Buttons.RightShoulder == ButtonState.Pressed || keyboard.IsKeyDown(Keys.D2))
