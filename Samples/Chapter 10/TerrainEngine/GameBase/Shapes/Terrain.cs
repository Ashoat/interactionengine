...
namespace TerrainEngine.GameBase.Shapes
{
    public class Terrain : DrawableGameComponent
    {
        ...
        public void Load(string heightmapFileName, int vertexCountX, int vertexCountZ, float blockScale,
            float heightScale)
        {
            if (!isInitialized)
                Initialize();
            ...
            FileStream fileStream = File.OpenRead(Game.Content.RootDirectory + 
                "/" + GameAssetsPath.TERRAINS_PATH + heightmapFileName + ".raw");
        ...
        private void GenerateTerrainMesh()
        {
            ...
            VertexPositionNormalTangentBinormal[] vertices = GenerateTerrainVertices(indices);

            // Create vertex and index buffers
            vb = new VertexBuffer(GraphicsDevice, numVertices * VertexPositionNormalTangentBinormal.SizeInBytes,
        ...
        */
         ...
         * The vertex is currently VertexPositionNormalTangentBinormal
         */
        private VertexPositionNormalTangentBinormal[] GenerateTerrainVertices(int[] terrainIndices)
        {
        ...
        private void GenerateTerrainNormals(VertexPositionNormalTangentBinormal[] vertices, int[] indices)
        {
