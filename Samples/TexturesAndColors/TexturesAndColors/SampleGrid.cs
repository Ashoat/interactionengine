...
namespace TexturesAndColorsSample
{
    public class SampleGrid : IDisposable
    {
        ...
        public void LoadGraphicsContent(GraphicsDevice graphicsDevice)
        {
            ...
            this.vertexBuffer = new VertexBuffer(device, this.vertexCount * 
                                                 VertexPositionColor.SizeInBytes,
                                                 BufferUsage.WriteOnly);
            this.vertexBuffer.SetData<VertexPositionColor>(vertices);

            this.vertexDeclaration = new VertexDeclaration(device, 
        ...
        public void Draw()
        {
            ...
            device.Vertices[0].SetSource(this.vertexBuffer, 0, 
                                         VertexPositionColor.SizeInBytes);
